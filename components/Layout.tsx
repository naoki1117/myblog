        ...
        <Grid columns={12} className="flex flex-1 justify-center w-screen gap-0">
            ...
            <Grid.Col md={4} className="cs:border-l-2 md:border-t-2">
                ...
                <div className='flex flex-col'>
                    ...
                    <a className='m-2 underline underline-offset-1 text-lg cursor-pointer hover:text-red-400' href='https://tailwindcss.com/docs/animation'>tailwindcss_@CSSframework</a>
